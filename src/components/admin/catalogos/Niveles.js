    ...
    <div>
      <div className='p-grid'>
        <div className='p-col-12'>
          <Card title='Administración de Niveles' className='card no-gutter widget-overview-box widget-overview-box-1'>
            ...
            {!loading && (
              <>
                ...
                >
                  ...
                  <Column field='level' header='Nivel' headerStyle={{ width: '30%' }} />
            ...
            <Dialog visible={entityDialog} header='Nivel' modal style={{ width: '50vw' }} className='p-fluid' footer={entityDialogFooter} onHide={hideDialog}>
              <div className='p-field'>
                ...
                />
                {submitted && !entity?.level && <medium className='p-invalid'>Se requiere el nombre del nivel.</medium>}
              </div>
            </Dialog>
            <Dialog visible={deleteEntityDialog} style={{ width: '450px' }} header='Confirmación' modal footer={deleteEntityDialogFooter} onHide={hideDialog}>
              <div className='p-d-flex p-ai-center p-jc-center'>
                ...
                {entity && (
                  <span>
                    ¿Estas seguro de borrar este nivel: <b>{entity.numero + '.-' + entity.level}</b>?
                  </span>
                )}
              </div>
            </Dialog>
            <Dialog visible={deleteEntitiesDialog} style={{ width: '450px' }} header='Confirmación' modal footer={deleteEntitiesDialogFooter} onHide={hideDialog}>
              <div className='p-d-flex p-ai-center p-jc-center'>
                <i className='pi pi-exclamation-triangle p-mr-3' style={{ fontSize: '2rem' }} />
                {entity && <span>¿Estas seguro de borrar los niveles seleccionados?</span>}
              </div>
            </Dialog>
          </Card>
        </div>
